...
<div class="d-flex justify-content-center">
	<div class="login-box">
		...
		<form id="loginForm" action="/user/sign_in" method="post">
			...
			<input type="submit" id="loginBtn" class="btn btn-block btn-primary mb-3" value="로그인">
			<span class="ml-5">아직 회원이 아니세요?</span>
			<a class="btn btn-block btn-dark mt-3" href="/user/sign_up_view">회원가입</a>
		</form>
	</div>
</div>
<script>
